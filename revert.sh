...
ls -r1 dirname/bedrock-server/servername/downloads/ | grep bedrock-server | head -2 | tail -1 >version_pin.txt
echo "Set previous version in version_pin.txt: $(cat dirname/bedrock-server/servername/version_pin.txt)"
